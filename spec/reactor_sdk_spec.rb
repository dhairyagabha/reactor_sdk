...
RSpec.describe ReactorSDK do
  ...
  it 'exposes all resource classes' do
    ...
    expect(defined?(ReactorSDK::Resources::LibrarySnapshot)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::LibraryComparisonEntry)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::LibraryComparison)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::UpstreamChainEntry)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::UpstreamChain)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::ComprehensiveResource)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::ComprehensiveRule)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::ComprehensiveDataElement)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::ComprehensiveExtension)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::ComprehensiveUpstreamChainEntry)).to eq('constant')
    expect(defined?(ReactorSDK::Resources::ComprehensiveUpstreamChain)).to eq('constant')
